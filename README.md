...
```
yarn install who-can-mongodb
```
```
npm install --save who-can-mongodb
```

### API

```
const WhoCan = require('who-can-mongodb'),
    MongoDB = require('mongodb');
    
MongoDB.connect('mongodb://localhost/database', async function(error, database) {
    if (error) {
